...
- **Note:** files sit under the folder for the day that teaches them — `day-01/` (`01`–`11`), `day-02/` (`12`–`19`), `day-03/` (`20`–`29`), `day-04/` (`30`–`34`), `day-05/` (`35`–`49`). The numeric prefix is the teaching order.
